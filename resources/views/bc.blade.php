    ...
    $(document).ready(function() {
        ...
        $('#bcebook-datatables').DataTable({
            ...
            columns: [{
                ...
                render: (data) => {
                    let downloadUrl =
                        `<a href="https://uploadhub-repository.politekniklp3i-tasikmalaya.ac.id/download-bcbook?file_name=${data.file_name}-${data.id}&typefile=${data.typefile}" class="bg-red-500 hover:bg-bg-red-300 px-3 py-1 rounded-md text-xs text-white">Download</a>`;
                    return `${downloadUrl}`;
                }
            }, ],
        });
